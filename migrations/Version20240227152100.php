 ...
 */
final class Version20240227152100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE author DROP books');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE author ADD books VARCHAR(255) NOT NULL');
